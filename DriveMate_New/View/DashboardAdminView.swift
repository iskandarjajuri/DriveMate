...
struct DashboardAdminView: View {
    ...
    let reports: [DriverReport] = [
        ...
        DriverReport(driverName: "Driver 2", cleanliness: "Cukup", safetyCommitment: "Ya", healthCondition: "Sehat", workingHours: "07:00 - 16:00"),
        DriverReport(driverName: "Driver 3", cleanliness: "Baik", safetyCommitment: "Tidak", healthCondition: "Kurang Fit", workingHours: "09:00 - 18:00")
    ]
    ...
    private func downloadReports() {
        _ = ReportDownloader.generateCSV(for: reports)
    }
